...
def main():
    ...
    # optionally pruning
    if args.prune:
        hook = FisherPruningHook(pruning=True, start_from=args.prune, penalty=[-1e-1,-1e-4,0,0])
        ...
        if i % args.print_freq == 0:
            if hook is not None:
                print('Epoch: [{0}][{1}/{2}]\t'
                      ...
                      'F: {hook.total_flops:.4f}. A: {hook.total_acts:.4f} {hook.penalty[0]} {hook.penalty[1]} {hook.penalty[2]} {hook.penalty[3]}'.format(
